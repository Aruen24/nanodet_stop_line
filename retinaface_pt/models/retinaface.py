...
from .detnas import ShuffleNetV2DetNAS
...
class RetinaFace(nn.Module):
    def __init__(self, cfg = None, phase = 'train'):
        ...
        if cfg['leaky']:
            logging.info('model will using leaky relu.')
            from .net_mobilenet_leaky import MobileNetV1 as MobileNetV1
            from .net_mobilenet_leaky import FPN as FPN
            from .net_mobilenet_leaky import SSH as SSH
        else:
            from .net_mobilenet import MobileNetV1 as MobileNetV1
            from .net_mobilenet import FPN as FPN
            from .net_mobilenet import SSH as SSH
        ...
        if cfg['name'] == 'mobilenet0.25':
            ...
            logging.info('using model pretrain: {}'.format(cfg['pretrain']))
            backbone = models.resnet50(pretrained=cfg['pretrain'])
            logging.info('loaded resnet50 backbone...')
